...
function RenewableEnergyFinancing() {
  const solutions = [
    'Solar installations for commercial customers',
    'Solar installations for industrial customers',
    ...
    <div className="about-page">
      ...
      <section className="page-hero about-hero">
        ...
        <div className="page-hero-content">
          <h1>Renewable Energy Financing</h1>
          <p>Clean and affordable energy solutions</p>
        </div>
      </section>
      ...
      <nav className="breadcrumb">
        <div className="container">
          ...
          <span className="separator">/</span>
          <span className="current">Renewable Energy Financing</span>
        </div>
      </nav>
        ...
        <div className="container">
          ...
          <div className="story-grid">
            <div className="story-content">
              ...
              <h2>Renewable Energy Financing</h2>
              <p>
                Promotes clean and affordable energy solutions, including solar installations for commercial, industrial, and residential customers, waste management, and smart city projects.
              </p>

              <div style={{ marginTop: '2rem' }}>
                <h3 style={{ fontSize: '1.1rem', marginBottom: '1rem', color: '#111827' }}>Solutions We Finance</h3>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {solutions.map((solution) => (
                    <li key={solution} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem', color: '#4b5563' }}>
                      <span style={{
                        width: '24px',
                        height: '24px',
...
export default RenewableEnergyFinancing
