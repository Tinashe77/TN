    ...
    <div className="about-page">
      ...
      <section className="page-hero about-hero">
        ...
        <div className="page-hero-content">
          <h1>Non-Profit Current Account</h1>
          <p>Schools, Churches, NGOs</p>
        </div>
      </section>
      ...
      <nav className="breadcrumb">
        <div className="container">
          ...
          <span className="separator">/</span>
          <span className="current">Non-Profit Current Account</span>
        </div>
      </nav>
        ...
        <div className="container">
          ...
          <div className="story-grid">
            <div className="story-content">
              <span className="section-label">Non-Profit Current Account</span>
              <h2>Schools, Churches, NGOs</h2>
              <p>
                This is a transactional account in which daily financial transactions can be conducted with ease. Account is suitable for schools, churches, NGOs, State owned Enteprises among others.
              </p>
...
export default NonProfitAccount
