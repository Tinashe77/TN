    ...
    <div className="about-page">
      ...
      <section className="page-hero about-hero">
        ...
        <div className="page-hero-content">
          <h1>Card Security</h1>
          <p>Chip & PIN protection for secure transactions</p>
        </div>
      </section>
      ...
      <nav className="breadcrumb">
        <div className="container">
          ...
          <span className="separator">/</span>
          <span className="current">Card Security</span>
        </div>
      </nav>
        ...
        <div className="container">
          ...
          <div className="story-grid">
            <div className="story-content">
              ...
              <h2>Card Security</h2>
              <p>
                The card uses Chip & PIN technology, also known as EMV, a feature that guarantees secure and safe transacting. Your transactions are protected with multiple layers of security.
              </p>
...
export default VisaCardSecurity
