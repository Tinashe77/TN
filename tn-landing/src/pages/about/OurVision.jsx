    ...
    <div className="about-page">
      ...
      <section className="page-hero about-hero" style={{ backgroundImage: "url('/banners/About-us-op.png')" }}>
        ...
        <div className="page-hero-content">
          <h1>Our Vision</h1>
          <p>Embedded Banking for Everyone</p>
        </div>
      </section>
      ...
      <nav className="breadcrumb">
        <div className="container">
          ...
          <span className="separator">/</span>
          <span className="current">Our Vision</span>
        </div>
      </nav>
      ...
      <section className="content-section white-section">
        <div className="container">
          ...
          <div className="centered-content" style={{ marginBottom: 0 }}>
            ...
            <h2 style={{ color: '#111827' }}>Embedded Banking for Everyone</h2>
            <p style={{ fontSize: '1.25rem', lineHeight: '2', color: '#4b5563' }}>
              To embed banking seamlessly — through trusted partnerships and digital technology — into the products and services that people everywhere use every day.
            </p>
          </div>
        </div>
      </section>
