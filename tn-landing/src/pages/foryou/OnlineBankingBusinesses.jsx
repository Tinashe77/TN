...
function OnlineBankingBusinesses() {
  const registrationSteps = [
    {
      number: '1',
      title: 'Fill Mandate Form',
      description: 'Complete the Corporate Online Banking Mandate Form and submit it to your Account Executive.',
    },
    {
      number: '2',
      title: 'Profile Creation',
      description: 'Bank Operations creates your corporate online banking profile.',
    },
    {
      number: '3',
      title: 'Receive Credentials',
      description: 'Receive your OTP and password via email/SMS. Each individual receives a One-Time code to set up their profile.',
    },
  ]
        ...
        <div className="container">
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <h2 style={{ color: '#111827', fontSize: '1.75rem', marginBottom: '0.75rem' }}>Corporate Online Banking</h2>
              <p style={{ color: '#4b5563', fontSize: '1rem', lineHeight: '1.6', maxWidth: '700px', margin: '0 auto' }}>
                Streamline your business banking with TN CyberTech Bank's Corporate Online Banking platform. Manage accounts, authorize payments, and access real-time financial data for your organization.
              </p>
            </div>
