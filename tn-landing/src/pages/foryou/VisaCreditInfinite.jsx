    ...
    <div className="page-container">
      ...
      <nav className="breadcrumb">
        <div className="container">
          ...
          <span className="separator">/</span>
          <span className="current">VISA Credit Infinite</span>
        </div>
      </nav>
        ...
        <div className="container">
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <h2 style={{ color: '#111827', fontSize: '1.75rem', marginBottom: '0.5rem' }}>VISA Credit Infinite</h2>
              <p style={{ color: '#4b5563', fontSize: '1rem', marginBottom: '1.5rem' }}>
                The ultimate premium credit card with exclusive lifestyle benefits and concierge services.
              </p>
      ...
      <section className="content-section light-section" style={{ textAlign: 'center' }}>
        <div className="container">
          ...
          <p style={{ color: '#6b7280', marginBottom: '2rem', maxWidth: '500px', margin: '0 auto 2rem' }}>
            Contact our Card Centre to apply for your VISA Credit Infinite card.
          </p>
...
export default VisaCreditInfinite
